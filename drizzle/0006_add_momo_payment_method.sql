...
CREATE TABLE orders_new (
  ...
  payment_method TEXT NOT NULL CHECK (payment_method IN ('momo', 'bank_transfer', 'bank_transfer_mock', 'cod_mock', 'cod')),
...
VALUES (
  '0006_add_momo_payment_method',
  'Add momo payment method to orders payment_method check constraint',
  'f6c8b9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8',
