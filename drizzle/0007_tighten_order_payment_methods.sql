...
-- Validate every existing order before replacing the table. An unexpected legacy
-- payment method aborts here, before any source table is dropped.
...
-- This insert is the migration's safety gate. SQLite rejects any legacy mock/COD
-- row against the new CHECK constraint, leaving the original tables untouched.
...
VALUES (
  '0007_tighten_order_payment_methods',
  'Restrict order payment methods to momo and bank transfer',
  '574c31541851795909f7e736a109c7c09cff23606459e3ceb9391e06f0e0b1f3',
