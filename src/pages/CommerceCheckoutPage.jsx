...
import CommerceCheckoutSummary from '../components/CommerceCheckoutSummary'
...
function CommerceCheckoutPage() {
  ...
  function validate() {
    ...
    if (!form.unitCode && selectedAddressId && selectedAddressId !== 'new' && form.ward) {
      if (form.city !== HCMC_CITY) next.city = 'Hut Flower hiện chỉ giao hoa tại TP. Hồ Chí Minh.'
  ...
  </form><CommerceCheckoutSummary cartItems={cartItems} deliveryDraft={deliveryDraft} gifting={giftingPreview} subtotal={subtotal} /></div></Container></main>
}
